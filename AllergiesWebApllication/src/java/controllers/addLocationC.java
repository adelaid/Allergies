 ...
 * @author Ada
 */
public class addLocationC extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String location=request.getParameter("uname");
        System.out.println(location);
        triggerLocationManagement.addLocation(location);
        //sa se actualizeze repede lista
