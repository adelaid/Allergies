<%-- 
    Document   : RiskJSP
    Created on : Jan 17, 2017, 6:06:53 PM
    Author     : Ada
--%>
...
<% ArrayList<Risk> riskMap = (ArrayList<Risk>) session.getAttribute("riskMap");%>
        ...
        <div id="contentUser" style='background-size: 100% auto; background-attachment: fixed;'>
            ...
            <div class="loginform">
                ...
                <div class="form-element">
                                ...
                                <ul>
                                    <%for (Risk r : riskMap) {%>
                                    <li><h1><%=r.getLocation().getName()%> risks: </h1>
                                        <ul>
                                            <%for (Map.Entry<TriggerFactor, Integer> entry : r.getFactor().entrySet()) {%>
                                            <label for="name"><%=entry.getKey().getFactorName()%> : <%=entry.getValue()%> %</label>
                                            <%}%>
                                        </ul>
                                    </li>
                                    <%}%>
